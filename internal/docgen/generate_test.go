...
func TestStaleFilesRemoved(t *testing.T) {
	...
	os.WriteFile(staleFile, []byte("<!-- auto-generated by cmd/docgen — do not edit -->\n\n# stale"), 0o644)

	// Plant a hand-maintained .md file (no auto-generated header)
	manualFile := filepath.Join(outDir, "NOTES.md")
	os.WriteFile(manualFile, []byte("# Hand-maintained notes\n"), 0o644)
...
`
	os.WriteFile(skillPath, []byte(original), 0o644)
