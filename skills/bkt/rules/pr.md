...
| [comments](#bkt-pr-comments) | List comments on a pull request | `--details`, `--project`, `--repo`, `--state`, `--workspace` |
...
# List all comments
  ...
  # Show full details (file anchor, resolved status, task completion)
